...
func (a *Loop) RunStream(ctx context.Context, cfg RunConfig, userMessage any, cb *bs.StreamCallbacks) (resultText string, resultTraces []ToolTrace, runErr error) {
	...
	defer func() { finishRunOutcome(ctx, cfg, outcome, runErr) }()
